...
In order to support loading of multiple wallets in nmn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nmn.cpp.
...
Changes to nmn.cpp
----------------------
nmn.cpp is the entry point into nmn-qt, and as such, will require some minor modifications to provide hooks for
