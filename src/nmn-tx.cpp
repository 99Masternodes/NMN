...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("99Masternodes Core nmn-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nmn-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nmn transaction") + "\n" +
                               "  nmn-tx [options] -create [commands]   " + _("Create hex-encoded nmn transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nmn transaction
