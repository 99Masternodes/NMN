...
extern UniValue setznmnseed(const UniValue& params, bool fHelp);
extern UniValue getznmnseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdznmn(const UniValue& params, bool fHelp);
extern UniValue dznmnstate(const UniValue& params, bool fHelp);
