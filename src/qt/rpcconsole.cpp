                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzNMNPathCustom = GetArg("-znmnbackuppath", "");
    ...
    if(!strzNMNPathCustom.empty()) {
        ui->wallet_customznmnbackuppath->setText(QString::fromStdString(strzNMNPathCustom));
        ui->wallet_customznmnbackuppath_label->setVisible(true);
        ui->wallet_customznmnbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzNMNPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the NMN RPC console.") + "<br>" +
