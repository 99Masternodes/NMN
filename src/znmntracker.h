...
#ifndef NMN_ZNMNTRACKER_H
#define NMN_ZNMNTRACKER_H
...
public:
    CzNMNTracker(std::string strWalletFile);
    ~CzNMNTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzNMNWallet* zNMNWallet = NULL);
