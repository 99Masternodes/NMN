...
#ifndef NMN_ZNMNWALLET_H
#define NMN_ZNMNWALLET_H
...
public:
    CzNMNWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZNMN(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZNMN(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
