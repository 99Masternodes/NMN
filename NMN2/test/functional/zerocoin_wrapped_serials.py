#!/usr/bin/env python3
# Copyright (c) 2019 The NMN Core developers
...
from fake_stake.base_test import NMN_FakeStakeTest

class zNMNwrappedSerialsTest(NMN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zNMNs..." % DENOM_TO_USE)
