...
/* NMN GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "NMN"
#define QAPP_ORG_DOMAIN "99masternodes.com"
#define QAPP_APP_NAME_DEFAULT "NMN-Qt"
#define QAPP_APP_NAME_TESTNET "NMN-Qt-testnet"
