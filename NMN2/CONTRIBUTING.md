Contributing to NMN Core
============================

The NMN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NMN Core project, and is not to be
confused with overall NMN Network Protocol consensus changes.

Whether a pull request is merged into NMN Core rests with the project merge
...
Patches that change NMN consensus rules are considerably more involved than
...
Where a patch set proposes to change the NMN consensus, it must have been
...
The project leader is the release manager for each NMN Core release.
